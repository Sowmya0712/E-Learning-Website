...
<div class="navbar  navbar-inverse">
    <div class="navbar-inner">
        <div class="footerindex">
            <center><img width="25" height="25" src="admin/img/chmsc.png">&nbsp;NHCE E-Learning System </center>
        </div>
        <!-- modal -->
        <!-- mission -->
        ...
        <div id="vision" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <p>NHCE ExCELS: Excellence, Competence, and Educational Leaderhip in Science and Technology.</p>
